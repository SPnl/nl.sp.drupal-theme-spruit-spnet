...
count.async = !0;
count.src = protocol + "//hello.myfonts.net/count/2ae1dc";
...
a: for (; i < browLen; i++) {
    ...
    if (regex.test(navigator.userAgent)) {
        ...
        for (j = 0; j < typeLen; j++)
            if (browserVersion >= browsers[i].type[j].version && (!0 == browsers[i].unhinted && (suffix = "_unhinted"),
            webfontType = browsers[i].type[j].type,
            "woff" != webfontType || woffEnabled) && ("svg#wf" != webfontType || svgEnabled))
                break a
    } else
        webfontType = "woff"
}
...
for (var fonts = [{
    fontFamily: "HelveticaInseratLTPro",
    url: wfpath + "2AE1DC_0" + suffix + "_0." + webfontType
}, {
    fontFamily: "HelveticaNeueLTStd-Md",
    url: wfpath + "2AE1DC_1" + suffix + "_0." + webfontType
}, {
    fontFamily: "HelveticaNeueLT-Light",
    url: wfpath + "2AE1DC_2" + suffix + "_0." + webfontType
}, {
    fontFamily: "HelveticaNeueLTStd-BdCn",
    url: wfpath + "2AE1DC_3" + suffix + "_0." + webfontType
}, {
    fontFamily: "HelveticaNeueLTStd-LtIt",
    url: wfpath + "2AE1DC_4" + suffix + "_0." + webfontType
